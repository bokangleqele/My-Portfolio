    ...
    },
    {
        ...
        contact: (
            <a
                ...
                className="text-blue-500 underline hover:text-blue-700 dark:text-blue dark:hover:text-blue-700"
            >
                    ...
                    <ul className="mt-12 grid grid-cols-1 gap-12 md:grid-cols-3">
                        {contactMethods.map((item, idx) => (
                            <li key={idx} className="flex flex-col items-center">
                                <div className="flex-none text-gray-800 mb-2 dark:text-white">
                                    {item.icon}
                                </div>
                                <h4 className="text-gray-800 text-lg font-medium dark:text-white">{item.title}</h4>
                                <p className="text-base text-center dark:text-white">{item.contact}</p>
                            </li>
                        ))}
                    </ul>
                </div>
